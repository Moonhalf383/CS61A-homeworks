...
class VendingMachine:
    ...
    def add_funds(self, n):
        ...
        "*** YOUR CODE HERE ***"
        if self.stock == 0:
            return "Nothing left to vend. Please restock. Here is your ${0}.".format(n) 
        else:
            self.balance += n 
    ...
    def vend(self):
        ...
        if self.stock == 0:
        ...
        elif self.balance>=self.price and self.balance % self.price == 0:
            ...
            return 'Please add ${0} more funds.'.format(self.price - self.balance)
...
def store_digits(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    output_link = Link(n%10)
    n //= 10
    while n > 0:
        output_link = Link(n%10,Link(output_link.first,output_link.rest))
        n //= 10 
    return output_link
